...
if shap_values_class_1.ndim == 1:  # 如果 SHAP 值是 1D 数组
    # 如果是1D数组，其他SHAP之和是计算前 5 个特征外的所有剩余特征的 SHAP 值
...
selected_shap_values = np.concatenate(
    [shap_values_class_1[top_5_indices].reshape(-1, 1), np.array([other_shap_sum]).reshape(-1, 1)],
    axis=1
)
...
# 保存图像到不同的目录
image_path = "C:/Users/LWL/OneDrive/Desktop/Temp/shap_force_plot_class_1_selected.png"
